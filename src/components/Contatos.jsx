  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#091f3f] flex justify-center items-center p-4'>
        <form action="https://getform.io/f/14936c2f-ffa4-45bd-92fb-0f61f8f0b189" method='POST' encType='multipart/form-data' className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-red-700 text-gray-300'>Contato</p>
            ...
            <button className='text-white border-2 hover:bg-red-700 hover:border-red-700 px-4 py-3 my-8 mx-auto flex items-center'>Enviar</button>
        </form>
